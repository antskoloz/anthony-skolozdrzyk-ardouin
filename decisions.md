...
**Status:** Deployed 2026-09-13 at `https://anthony-site-cms-auth.anthony-skolozdrzyk.workers.dev`, referenced from `public/admin/config.yml`'s `backend.base_url`. The Pages-source flip (part 2) is still pending — see [todo.md](todo.md).
