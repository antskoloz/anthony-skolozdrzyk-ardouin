...
- Free marketing tools (static vanilla, one folder each): `ab-test-calculator`, `chi-square-calculator`, `marketing-roi-calculator`, `utm-builder`, `saas-metrics-calculator` — behavior in [free-tools.md](free-tools.md), decision in [decisions.md](../decisions.md) ADR-004. Listed here as they ship.
